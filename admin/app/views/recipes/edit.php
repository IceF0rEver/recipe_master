<div class="bg-gray-700 text-white rounded-lg shadow-2xl p-6 my-6">
    <h1 class="text-2xl font-bold mb-4">Modifier une recette</h1>

    <form action="recipes/edit/form" method="post" class="text-gray-800">
        <input type="hidden" name="id" value="<?php echo $recipe['dish_id'];?>">
        <div class="mb-4">
            <label for="name" class="block text-sm font-medium text-gray-300">Nom de la recette</label>
            <input type="text" name="name" id="name" value="<?php echo $recipe['dish_name'];?>" required class="mt-1 p-2 w-full border rounded-md">
        </div>

        <div class="mb-4">
            <label for="description" class="block text-sm font-medium text-gray-300">Description</label>
            <input type="text" name="description" id="description" value="<?php echo $recipe['dish_description'];?>" required class="mt-1 p-2 w-full border rounded-md">
        </div>

        <div class="mb-4">
            <label for="prep_time" class="block text-sm font-medium text-gray-300">Temps de preparation</label>
            <input type="text" name="prep_time" id="prep_time" value="<?php echo $recipe['dish_prep_time'];?>" class="mt-1 p-2 w-full border rounded-md">
        </div>

        <div class="mb-4">
            <label for="portions" class="block text-sm font-medium text-gray-300">Portions</label>
            <input type="text" name="portions" id="portions" value="<?php echo $recipe['dish_portions'];?>" class="mt-1 p-2 w-full border rounded-md">
        </div>

        <div class="mb-4">
            <label for="picture" class="block text-sm font-medium text-gray-300">Nom de l'image de la recette</label>
            <input type="text" name="picture" id="picture" value="<?php echo $recipe['dish_picture'];?>" class="mt-1 p-2 w-full border rounded-md">
        </div>
        <div class="m-4">
            ...
            <?php
                ...
                $ingredients = \App\Models\IngredientsModel\findAllInByRecipeId($connexion, $recipe['dish_id']);
        ...
        <div class="mb-4">
            ...
            <select id="default" name="type_id" required class="bg-gray-50 border border-gray-300 text-gray-900 mb-6 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                <?php
                    ...
                    $categories = \App\Models\CategoriesModel\findAllInByRecipeId($connexion, $recipe['dish_id']);
        ...
        <div class="mb-4">
            ...
            <select id="default" name="user_id" required class="bg-gray-50 border border-gray-300 text-gray-900 mb-6 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                <?php
                    ...
                    $users = \App\Models\UsersModel\findAllInByRecipeId($connexion, $recipe['dish_id']);
